var albumPicasso = {
 ...
 var albumlove = {
     ...
     albumArtUrl: 'assets/images/album_covers/20.png',
     songs: [
         { title: 'Save Up all your tears', duration: '1:01' },
         { title: 'Love Hurts', duration: '5:01' },
         { title: 'Love and Understanding', duration: '3:21'},
         { title: 'Fire', duration: '3:14' },
         { title: 'Never Stop', duration: '2:15'}
     ]
 };
...
var findParentByClassName = function(element, targetClass) {
    if (element) {
        ...
        while (currentParent.className !== targetClass && currentParent.className !== null) {
          ...
          else if (currentParent && (currentParent.className === targetClass)){
